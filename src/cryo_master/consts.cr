module Consts
  # MIDI and CryoMaster constants.

  # Number of MIDI channels
  MIDI_CHANNELS = 16_u8
  # Number of note per MIDI channel
  NOTES_PER_CHANNEL = 128_u8
  ...
  NOTE_ON = 0x90_u8
  # Note, val
  POLY_PRESSURE = 0xA0_u8
  # Controller #, val
  CONTROLLER = 0xB0_u8
  # Program number
  PROGRAM_CHANGE = 0xC0_u8
  # Channel pressure
  CHANNEL_PRESSURE = 0xD0_u8
  # LSB, MSB
  PITCH_BEND = 0xE0_u8
  ...
  SONG_POINTER = 0xF2_u8
  # Val number of song
  SONG_SELECT = 0xF3_u8
  # Tune request
  TUNE_REQUEST = 0xF6_u8
  ...
  ACTIVE_SENSE = 0xFE_u8
  # System reset
  SYSTEM_RESET = 0xFF_u8
  ...
  # Val must be 0
  CM_ALL_NOTES_OFF = 0x7B_u8
  # Val must be 0
  CM_OMNI_MODE_OFF = 0x7C_u8
  # Val must be 0
  CM_OMNI_MODE_ON = 0x7D_u8
  # Val = # chans
  CM_MONO_MODE_ON = 0x7E_u8
  # Val must be 0
  CM_POLY_MODE_ON = 0x7F_u8
end
